...
public class AetherfallWeaponItem extends RangedWeaponItem {
    public AetherfallWeaponItem(Settings settings) {
        super(settings);
    }
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if ((double)(f = BowItem.getPullProgress(i = this.getMaxUseTime(stack) - remainingUseTicks)) < 0.3) {
            return;
        }
